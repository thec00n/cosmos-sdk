...
func (m *Manager) RegisterServicesV2(builder *stf.MsgRouterBuilder) error { // most important part of the PR to finish
	// for _, module := range m.Modules {
...
// UpgradeBlockerV2 is UpgradeBlocker for server v2, it supports only the upgrade module
func (m *Manager) UpgradeBlockerV2() func(context.Context) (bool, error) {
...
func (m *Manager) BeginBlockV2() func(ctx context.Context) error {
...
// TODO refactor away from mm
func (m *Manager) EndBlockV2() (endblock func(ctx context.Context) error, valupdate func(ctx context.Context) ([]appmanager.ValidatorUpdate, error)) {
	validatorUpdates := []abci.ValidatorUpdate{}
